...
SET password_hash = CASE user_id
    WHEN 0 THEN '42d4880101dc65c98af462d6c135870a4b633d16bdc0a27177e74d2d65442710'
    WHEN 1 THEN 'baacd9c5708224c165546976a268f465e82c1e27a18dbd5f9dadd28bf800b95b'
    WHEN 2 THEN 'cc42ec19e6892808bf7c07469f09bb7f5efabc50e081d7c3928f4a85375e7858'
    WHEN 3 THEN 'c476e75eebf00fac91bf0aaa7a1b88a03d1500f8e51d09f6d945157b69f5278f'
    WHEN 4 THEN '004847921a3fe0fcc92f0d18450edc08c6d9294b5cdc8831ea7ef90eab0e07a0'
    WHEN 5 THEN 'c04364baa8f1987f5f368742d0efaba6b7186543ff8b8004b6e0231b80e7a049'
    WHEN 6 THEN '8f1b9c83da2ff3889718dfc3f385741b59761ede7052e980dffbef3ed7ac20c9'
    WHEN 7 THEN 'e029771a051d6baa3da725576643424fa61d0e3c6df11d2e6c28caba2ea05728'
    WHEN 8 THEN '79b7ee15434a2901a95982387862a828b56262800c19296a37beced3ccf70c1b'
    WHEN 9 THEN '20256c50e60ae2e03d7f2d346979df2b790331af132a2cdaa9688e0a76d4cf5e'
    WHEN 10 THEN 'afb359c0410c386614e3c55d766ebc8951c362ea2d83c8f0bc82df3bfca5fbea'
    WHEN 11 THEN '7e9eb936e0cfbebbc0822e483aa732e1dc3be40fb4168ff310098e5a17c41cb3'
    WHEN 12 THEN 'aa17e9453d8f24e69d036b06e610a810e0d5d02a6d676c027b9b5326c15fd3da'
    WHEN 13 THEN '92feb87c4dc833af6c2b82d8e2d1eed14d2bf67810500cae27156f782fa603ad'
    WHEN 14 THEN 'c517f7b5d439f3019009bf366a60f4a7f80296f043c1024574b0b11b062a22a5'
    WHEN 15 THEN 'ca598dd8522f591b770554e906fd0cda0814af0c53601dc472ea81560bb8433a'
    WHEN 16 THEN '3e6abf60f05be9529cbb2a55c3ba3980b646ad75d041330fbe611a2a5fa10eb1'
    WHEN 17 THEN '95d94f1bcd6cf0843770a8a3d1099e3ba7af24333f553811297caddd00897822'
    WHEN 18 THEN 'de1dedf13bd9acbe5bd9c32a5abe59ac62099a42ec98e695abe4fb6b5d69f161'
    WHEN 19 THEN '24413cdd9a4c1313e19a27c6464f72a340ad0ee1cddef1fac8b48457b7d2b50f'
    WHEN 20 THEN '0fa05aa264bfd0b77840b16db18ab7ecfbd3fbd33ec37dae85576f5923acabe4'
END,
    salt = CASE user_id
    WHEN 0 THEN 'c4107d605f18946a84b5c8e7cecd27ed'
    WHEN 1 THEN '70e59b125a52e3250f5cd279c626f093'
    WHEN 2 THEN '71a7a9c30c27ffeb2559764ab8fad254'
    WHEN 3 THEN '692ba015e752b86bf7829ba4e9f12210'
    WHEN 4 THEN 'd26f08604ebc99d2bb7a7a67000c5054'
    WHEN 5 THEN 'd31caf870d811f60dc22317047de517d'
    WHEN 6 THEN '3c6344d6c443fd05d65912817287fa87'
    WHEN 7 THEN 'f1ab48d6ba012482fd04922135bc1470'
    WHEN 8 THEN '69a75896b80310845bbcd00a0c712715'
    WHEN 9 THEN '9dfbc62c83daf3a142ffdac1158fab56'
    WHEN 10 THEN 'c96696341d7b6f56c8678b3c8360f3c1'
    WHEN 11 THEN 'c94336d8b684fa33c96e3579ec4f23c2'
    WHEN 12 THEN 'a9302cac41e563be98503f73a0b36bfa'
    WHEN 13 THEN '7723846e018f1c45dd2f58745b64a256'
    WHEN 14 THEN '25ce875efe9004c26f574cbcd18e59c8'
    WHEN 15 THEN 'aad9310ef35d87eca6e9465231b342ee'
    WHEN 16 THEN 'f8935eea283074dafa836f59cdec1c9b'
    WHEN 17 THEN '44bbbcb2520c1c38989ce3a422160fb7'
    WHEN 18 THEN '87ebae73b2366b7c7f6ca9a26767c171'
    WHEN 19 THEN 'e0adbe8abb723efdc2a6b685e28c4454'
    WHEN 20 THEN '641fd70c44a9397a30f0745b1fd8be82'
END
WHERE user_id BETWEEN 0 AND 20;