        ...
        <main class="main-area">
            ...
            <div class="chat-container empty-state">
                <div class="welcome-panel">
                    ...
                    <h2 class="welcome-title">Welcome to RAGdoll AI</h2>
                    <p class="welcome-text">
                        Start a new task, review your previous chats, or switch models without losing focus.
                    </p>
                    <div class="welcome-grid">
                        ...
                        <div class="welcome-card">
                            ...
                            <br>
                            <span>Select the right workflow</span>
                        </div>
                    </div>
                </div>
            </div>
