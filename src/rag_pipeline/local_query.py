...
# Keep runtime-generated bytecode out of the project tree. This is set before
# importing embedding.py so that module cannot create an __pycache__ directory.
